...
public class TargetCamera : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        camRectNormal = GetComponent<Camera>().rect;  //updated from Unity 4 code
    }
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0) || Input.GetMouseButtonDown(1))
        {
            ...
            //ShowShot(sh);   //Commented out this line
        ...
        if (Input.GetKeyDown(KeyCode.Tab))
        {
            ...
            GetComponent<Camera>().rect = new Rect(0, 0, 1, 1); //updated from Unity 4 code
        }
        if (Input.GetKeyUp(KeyCode.Tab))
        {
            // Return to normal when Tab is released
            GetComponent<Camera>().rect = camRectNormal;  //updated from Unity 4 code
        }
